...
Proto.m_watchdog_auth_toc = {__name = "m_watchdog_auth_toc", __mod = 1, error = 0, result = false}
...
Proto.m_scene_enter_toc = {__name = "m_scene_enter_toc", __mod = 3, error = 0, pos = {}, objs = {}}
